...
<html>
	<head>
		<meta charset="utf-8">
		<meta name="descrption" content="Coca colaes la bebidas ">
		...
		<script src="https://kit.fontawesome.com/82c9e7b922.js" crossorigin="anonymous"></script>
	</head>
	<body>
		<header>
			<div class="container">
		...
		<main>
			...
			<section id="contactenos" class="seccion">
				<iframe width="643" height="400" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" id="gmap_canvas"></iframe>
				<div class="container-fluid">
					<div class="row">
									...
									if($_SERVER["REQUEST_METHOD"]== "POST")
									{
										...
										if(isset($nombre))
										{
											if(isset($email))
											{
												if(isset($mensaje))
												{
													$para = "tuttyaguilar@gmail.com";
													$asunto = "esto es una prueba";
													$cuerpo = $nombre. "\n".$email."\n".$mensaje;
													$adicional = "Form: dannybaculima@gmail.com";
			...
			<div class="container">
				<div class="row">
					...
					<div class="columna columna-25 columna-mobile-100">
						...
						<ul>
							<li>tuttyaguilar@gmail.com</li>
							<li>0960830212</li>
							<li>Av. Loja e isabela catolica</li>
						</ul>
					</div>
					<div class="columna columna-25 columna-mobile-100">
						<h3>
